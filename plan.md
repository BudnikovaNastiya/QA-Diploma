...
* Системное (без тз на основе опыта и ожиданий работы подобных приложений)
...
#### Ожидаемые результаты работы с БД
* Должен подтверждать покупку или кредит по карте со статусом APPROVED.
* Не должен подтверждать покупку или кредит по карте со статусом DECLINED.
* Не должен подтверждать покупку или кредит по несуществующей карте.
* Не должен отправлять запрос на оплату с некорректным именем владельца.
...
2. Кредит по карте со статусом DECLINED
Номер карты 4444 4444 4444 4442, остальные поля заполнены корректными значениями  
Ожидаемый результат: появилось всплывающее окно "Ошибка! Банк отказал в проведении операции".
